...
public final class SPUtils {
    public static final String KEY_CACHE_ICD_DATA_FORMAT = "cache_icd_data_%s";
    public static final String KEY_CACHE_ICD_DATA_TIME_FORMAT = "cache_icd_data_time_%s";
    ...
    public static SPUtils getInstance(final int mode) {
        return getInstance("defaultSPConfig", mode);
    }
